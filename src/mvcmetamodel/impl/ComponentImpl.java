 ...
 * @generated
 */
public class ComponentImpl extends ContentImpl implements Component {
	/**
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<Component>(Component.class, this, MvcmetamodelPackage.COMPONENT__COMPONENTS);
		}
		return components;
	}
