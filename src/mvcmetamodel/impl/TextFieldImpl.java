 ...
 * <ul>
 *   <li>{@link mvcmetamodel.impl.TextFieldImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextFieldImpl extends ComponentImpl implements TextField {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MvcmetamodelPackage.TEXT_FIELD__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MvcmetamodelPackage.TEXT_FIELD__TEXT:
				return getText();
		}
