 ...
 * <ul>
 *   <li>{@link mvcmetamodel.impl.HeadImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HeadImpl extends EObjectImpl implements Head {
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MvcmetamodelPackage.HEAD__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MvcmetamodelPackage.HEAD__TITLE:
				return getTitle();
		}
